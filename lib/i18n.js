/**
 * dsh-memory-evolve-suite — host-side i18n runtime (English support, 2026-08-25).
 *
 ...
 *
 * @module dsh-memory-evolve-suite/i18n
 */
...
export const NOTIFY_DICT = {
  ...
  'coin.sender': ['👤 发送人：DSH AI 助手（dsh-memory-evolve-suite）', '👤 Sender: DSH AI assistant (dsh-memory-evolve-suite)'],
