...
**配套技能**：AI 使用本适配器的完整细则见技能 \`kimi-cli-calling\`（由 dsh-memory-evolve-suite 插件内置提供，默认启用；可在「技能管理」Tab 中禁用）。
...
**配套技能**：AI 使用本适配器的完整细则见技能 \`codex-cli-calling\`（由 dsh-memory-evolve-suite 插件内置提供，默认启用；可在「技能管理」Tab 中禁用）。
...
**配套技能**：AI 使用本适配器的完整细则见技能 \`grok-cli-calling\`（由 dsh-memory-evolve-suite 插件内置提供，默认启用；可在「技能管理」Tab 中禁用）。
...
**配套技能**：AI 使用本适配器的完整细则见技能 \`hermes-cli-calling\`（由 dsh-memory-evolve-suite 插件内置提供，默认启用；可在「技能管理」Tab 中禁用）。
