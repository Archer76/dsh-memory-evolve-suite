/**
 * dsh-memory-evolve-suite — 提示词管理器（Prompt Manager）模块。
 *
 ...
 *
 * @module dsh-memory-evolve-suite/prompts
 */
...
export function installPrompts(ctx, config) {
  ...
  ), 'dsh-memory-evolve-suite: prompts tool'))
  ...
  }, 'dsh-memory-evolve-suite: prompt injections snapshot'))
  ...
  ctx.inject(['webServer'], (webCtx) => {
    ...
    }, 'dsh-memory-evolve-suite: prompts web api')
  })
