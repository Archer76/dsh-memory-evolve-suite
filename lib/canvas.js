/**
 * dsh-memory-evolve-suite — 无限画板（canvas）**独立子模块**（后端一期）。
 *
 ...
 * @module dsh-memory-evolve-suite/canvas
 */
...
export function installCanvas(ctx, config, resolveCwd, resolveSessionName) {
  ...
  ), 'dsh-memory-evolve-suite: de_canvas tool')
  ...
  ctx.inject(['webServer'], (webCtx) => {
    ...
    }), 'dsh-memory-evolve-suite: canvas route')
